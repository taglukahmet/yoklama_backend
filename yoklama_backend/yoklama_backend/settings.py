"""
Django settings for yoklama_backend project.
...
INSTALLED_APPS = [
    ...
    'qr_generation.apps.QrGenerationConfig',
...
ROOT_URLCONF = 'yoklama_backend.urls'
...
WSGI_APPLICATION = 'yoklama_backend.wsgi.application'
